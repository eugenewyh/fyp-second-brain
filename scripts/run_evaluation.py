#!/usr/bin/env python3
"""Run the 52-query benchmark evaluation suite."""
...
def main():
    ...
    parser.add_argument("--category", "-c", help="Filter by category (personal_java, hybrid, research, edge_gaps)")
    ...
    parser.add_argument("--ids", help="Comma-separated query IDs (e.g. PJ01,HY01)")
    ...
    assert len(benchmarks) == 52, f"Expected 52 benchmarks, got {len(benchmarks)}"
    ...
    report = run_evaluation(benchmarks, output, resume_from=resume_data)
